...
function show() {
    for (var item of datalist) {
        ...
        ul_li2.className = 'click';

        //创建ul li2 里的 a
        var ul_li2_a = document.createElement('a');
        ul_li2.appendChild(ul_li2_a);

        //创建ul li2 a里的 div
        var ul_li2_a_div = document.createElement('div');
        ul_li2_a_div.innerHTML = '关于云马智行车 C1还有 8 篇报告，点击查看';
        ul_li2_a.appendChild(ul_li2_a_div);
        ul_li2_a_div.className = 'click1';
